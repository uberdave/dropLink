...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // Parse initialization
     [Parse setApplicationId:@"Your Parse.com ApplicationID" clientKey:@"Your Parse.com clientKey"];
    // ****************************************************************************
    
    DBSession* dbSession =
    [[DBSession alloc]
      initWithAppKey:@"Your DropBox API AppKey"
      appSecret:@"Your DropBox API appSecret"
