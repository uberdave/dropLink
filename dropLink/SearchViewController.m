...
- (void)viewDidLoad {
    ...
    [self.mapView setRegion:MKCoordinateRegionMake(self.location.coordinate, MKCoordinateSpanMake(0.215, 0.215))];
...
- (void)updateLocations {
    ...
    NSNumber *distance = [NSNumber numberWithFloat:kilometers];
    NSDictionary *info = [NSDictionary dictionaryWithObjectsAndKeys:distance,@"howFar",_location,@"location", nil];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"locationUpdated" object:self userInfo:info];
